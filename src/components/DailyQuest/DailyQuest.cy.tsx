...
describe('<DailyQuest /> 컴포넌트 테스트', () => {
	beforeEach(() => {
		cy.mount(
			<DailyQuest progress={1} isLoggined={true}>
				<DailyQuest.Problem tier="Bronze" title="Test Quest 1" ratio={75} solved={false} id={1} />
				<DailyQuest.Problem tier="Silver" title="Test Quest 2" ratio={50} solved={true} id={2} />
			</DailyQuest>
		);
	});
